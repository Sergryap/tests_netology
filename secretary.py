...
def remove_doc_from_shelf(doc_number):
	"""Удаление номера документа из списка directories"""
...
def add_new_shelf(shelf_number=''):
	"""Создание новой полки, если ее нет"""
	if not shelf_number:
...
def append_doc_to_shelf(doc_number, shelf_number):
	"""Создание новой полки при ее отсутствии и добавление нового номера документа"""
